...
<style>
.hidden {overflow: hidden; width: 1px; height: 1px; color:transparent:;}
* {margin:0 auto; text-align:center;}
body {width:100%;background-color:black; margin:0 auto;}
nav {background-color:#181818; width:100%; line-height:48px;}
#notice {padding:0px 20px;color:white; z-index:3; position:sticky; background-color:#000000dd; vertical-align:middle; border-bottom:solid 1px #ffffffaa; height:48px; display:table; text-align:left;} 
#notice,nav{width:100%; height:30px;}
#gofull {padding:3px 0px; float:right; background:linear-gradient(#42a1ec,#0070c9); color:white; border:#07c solid 1px; border-radius:12px; font-size:12px; padding:3px 12px;}
a {vertical-align:middle; background-position:center; text-decoration:none;}
div {width:50%; background-clip:text; -webkit-background-clip:text;
color: transparent; text-align:left;}
li {list-style:none;}
p {word-break:keep-all; margin-top:29px; font-size:24px; font-weight:600; }
h2 {color:#ffe5db;}
...
<div style="color:#ffe5db; text-align:center;">
	<h2 style="display:block">환영합니다.</h2>
	<p>애플유저 커뮤니티입니다. :&#41;
		<br>활동을 시작하시기 전, 아래의 내용을 주의깊게 읽어주시기를 부탁드립니다.<br><br>

(본 내용은 회원의 편의를 위해 공지사항(애플 유저 커뮤니티 사용권 계약)을 요약한 것으로, 추가적인 설명이 필요한 경우 아래의 ‘전문’을 참고하시기 바랍니다.)</p>
</div>
...
관리자의 요청이 있을 경우, 10분 이내에 수정을 부탁드려요. 수정하지 않을 시 강제퇴장 조치됩니다.</li>
		<li>&#40;3&#41;. 아이폰, 아이폰 기종명, 앱등이, 맥북과 같은 닉네임은 중복 가능성이 높으므로 권장하지 않습니다. :&#41;</li>
	</ul>
	</p>
</div>
...
<div style="background-image:url(https://www.apple.com/v/iphone-xs/d/images/overview/copy_texture_6_large.jpg);">
	<h2>&#40;&#41;</h2>
	<p>
